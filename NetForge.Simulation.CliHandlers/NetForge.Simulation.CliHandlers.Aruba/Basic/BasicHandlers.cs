...
namespace NetForge.Simulation.CliHandlers.Aruba.Basic
{
    public static class BasicHandlers
    {
        ...
        /// </summary>
        public class ArubaPingHandler() : VendorAgnosticCliHandler("ping", "Send ICMP echo requests")
        {
        ...
        /// </summary>
        public class ArubaHostnameHandler() : VendorAgnosticCliHandler("hostname", "Set system hostname")
        {
            public override bool CanHandle(ICliContext context)
            {
                return context.CommandParts.Length >= 1 &&
        ...
        /// </summary>
        public class ArubaWriteHandler() : VendorAgnosticCliHandler("write", "Save configuration")
        {
            public override bool CanHandle(ICliContext context)
            {
                return context.CommandParts.Length >= 1 &&
        ...
        /// </summary>
        public class ArubaReloadHandler() : VendorAgnosticCliHandler("reload", "Restart the system")
        {
            public override bool CanHandle(ICliContext context)
            {
                return context.CommandParts.Length >= 1 &&
        ...
        /// </summary>
        public class ArubaEnableHandler() : VendorAgnosticCliHandler("enable", "Enter privileged mode")
        {
            public override bool CanHandle(ICliContext context)
            {
                return context.CommandParts.Length >= 1 &&
