...
namespace NetForge.Simulation.CliHandlers.Common.Common
{
    ...
    /// </summary>
    public class HistoryRecallCommandHandler() : VendorAgnosticCliHandler("!!", "Recall last command")
    {
    ...
    /// </summary>
    public class HistoryNumberRecallCommandHandler() : VendorAgnosticCliHandler("!", "Recall numbered command from history")
    {
        protected override async Task<CliResult> ExecuteCommandAsync(ICliContext context)
        {
