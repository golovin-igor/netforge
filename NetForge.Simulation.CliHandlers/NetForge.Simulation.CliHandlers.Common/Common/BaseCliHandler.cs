...
namespace NetForge.Simulation.Common.CLI.Base
{
    ...
    /// </summary>
    public abstract class BaseCliHandler(string commandName, string helpText) : ICliHandler
    {
        protected readonly Dictionary<string, ICliHandler> SubHandlers = new(StringComparer.OrdinalIgnoreCase);
        protected readonly List<string> Aliases = new();
        protected readonly string CommandName = commandName;
        protected readonly string HelpText = helpText;
        protected readonly List<string> ApplicableModes = new();
        ...
        public virtual bool CanHandle(ICliContext context)
        {
        ...
        public virtual CliResult Handle(ICliContext context)
            => HandleAsync(context).GetAwaiter().GetResult();

        public virtual async Task<CliResult> HandleAsync(ICliContext context)
        {
            try
            {
        ...
        protected abstract Task<CliResult> ExecuteCommandAsync(ICliContext context);
        ...
        public virtual List<string> GetCompletions(ICliContext context)
        {
        ...
        public virtual bool CanHandlePrefix(ICliContext context)
        {
            if (context.CommandParts.Length == 0)
                return false;
        ...
        public virtual List<(string, string)> GetSubCommands(ICliContext context)
        {
        ...
        /// </summary>
        protected virtual string GetContextualHelp(ICliContext context)
        {
