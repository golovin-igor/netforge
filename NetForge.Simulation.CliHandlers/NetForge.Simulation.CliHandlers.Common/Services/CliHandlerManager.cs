...
namespace NetForge.Simulation.Common.CLI.Base
{
    ...
    /// </summary>
    public class CliHandlerManager(INetworkDevice device) : ICliHandlerManager
    {
        private readonly List<ICliHandler> handlers = new();
        ...
        /// </summary>
        private string GetHelpText(ICliContext context)
        {
            var help = new List<string>();
