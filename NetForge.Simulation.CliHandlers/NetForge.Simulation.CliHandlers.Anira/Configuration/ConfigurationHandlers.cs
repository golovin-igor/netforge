...
namespace NetForge.Simulation.CliHandlers.Anira.Configuration
{
    /// <summary>
    ...
    /// </summary>
    public class IpAddressCommandHandler() : VendorAgnosticCliHandler("ip", "Configure IP parameters")
    {
        protected override async Task<CliResult> ExecuteCommandAsync(ICliContext context)
        {
            if (!IsVendor(context, "Anira"))
    ...
    /// </summary>
    public class ShutdownCommandHandler() : VendorAgnosticCliHandler("shutdown", "Shutdown interface")
    {
        protected override async Task<CliResult> ExecuteCommandAsync(ICliContext context)
        {
            if (!IsVendor(context, "Anira"))
    ...
    /// </summary>
    public class NoShutdownCommandHandler() : VendorAgnosticCliHandler("no", "Negate a command")
    {
        protected override async Task<CliResult> ExecuteCommandAsync(ICliContext context)
        {
            if (!IsVendor(context, "Anira"))
