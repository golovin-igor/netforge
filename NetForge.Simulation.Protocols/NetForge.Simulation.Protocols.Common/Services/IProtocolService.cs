...
{
    /// <summary>
    /// Basic protocol service interface for backward compatibility
    /// This interface provides access to protocol instances and states
    /// </summary>
    public interface IProtocolService
    {
        ...
        // Additional methods expected by test files
        /// <summary>
        ...
        IEnumerable<INetworkProtocol> GetProtocolsForVendor(string vendorName);
