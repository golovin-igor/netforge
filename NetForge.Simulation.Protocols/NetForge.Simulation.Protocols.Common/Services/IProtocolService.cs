...
namespace NetForge.Simulation.Protocols.Common.Services
{
    ...
    /// All new code should use IProtocolService
    /// </summary>
    [Obsolete("Use IProtocolService instead. This interface is maintained for backward compatibility.")]
    public interface IEnhancedProtocolService : IProtocolService
    {
        // This interface is now empty as all methods have been moved to IProtocolService
