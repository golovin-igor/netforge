...
using NetSim.Simulation.Protocols.CDP;
using NetSim.Simulation.Protocols.Routing;

namespace NetSim.Simulation.Protocols.Tests
{
    /// <summary>
    ...
    public class CdpProtocolTests : IDisposable
    {
        ...
        {
            // Arrange
            var cdpState = _cdpProtocol.GetTypedState<NetSim.Simulation.Protocols.CDP.CdpState>();
        ...
        public async Task CdpProtocol_NeighborTimeout_ShouldRemoveStaleNeighbors()
        {
            ...
            var staleNeighbor = cdpState.GetOrCreateCdpNeighbor("StaleDevice:GigabitEthernet0/1", 
                () => new NetSim.Simulation.Protocols.CDP.CdpNeighbor("StaleDevice", "GigabitEthernet0/1", "GigabitEthernet0/1")
                {
        ...
        {
            // Arrange & Act
            var state = new NetSim.Simulation.Protocols.CDP.CdpState();
        ...
        {
            // Arrange & Act
            var neighbor = new NetSim.Simulation.Protocols.CDP.CdpNeighbor("Switch.example.com", "GigabitEthernet0/1", "GigabitEthernet0/2")
            {
