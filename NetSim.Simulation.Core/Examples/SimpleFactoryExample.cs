namespace NetSim.Simulation.Examples
{
    ...
    /// Note: This example shows the structure without requiring NetSim.Entities dependencies
    /// </summary>
    public class SimpleFactoryExample
    {
        ...
        public static async Task RunSimpleExampleAsync()
        {
            ...
            Console.WriteLine("   - Converts NetSim.Entities.Topology.Device to CommandProcessing devices");
            ...
            Console.WriteLine("1. Ensure NetSim.Entities project is referenced");
