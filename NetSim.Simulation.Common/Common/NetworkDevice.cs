...
using INetworkProtocol = NetSim.Simulation.Interfaces.INetworkProtocol;
using NetSim.Simulation.Events;
using NetSim.Simulation.Protocols.Discovery;

namespace NetSim.Simulation.Common
{
    /// <summary>
    ...
    public abstract class NetworkDevice : INetworkDevice, ICommandProcessor
    {
        ...
        protected readonly Dictionary<string, InterfaceConfig> Interfaces = new();
        protected readonly Dictionary<int, VlanConfig> Vlans = new();
        protected readonly List<Route> RoutingTable = [];
        protected readonly Dictionary<int, AccessList> AccessLists = new Dictionary<int, AccessList>();
        protected readonly Dictionary<int, PortChannel> PortChannels = new Dictionary<int, PortChannel>();
        protected readonly Dictionary<string, string> SystemSettings = new Dictionary<string, string>();
        ...
        protected readonly CliHandlerManager CommandManager;
        protected readonly CommandHistory.CommandHistory CommandHistory;
        ...
        protected NetworkDevice(string name)
        {
            ...
            CommandHistory = new CommandHistory.CommandHistory(1000); // Max 1000 commands
        }
    ...
    // Synchronous ProcessCommand removed. Use ProcessCommandAsync instead.
        ...
        /// </summary>
        public CommandHistory.CommandHistory GetCommandHistory()
        {
        ...
        /// </summary>
        public Dictionary<string, InterfaceConfig> GetAllInterfaces() => Interfaces;
        ...
        public void SetOspfConfiguration(OspfConfig config)
        {
            ...
            OspfConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.OSPF,
        ...
        public void SetBgpConfiguration(BgpConfig config)
        {
            ...
            BgpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.BGP,
        ...
        public void SetRipConfiguration(RipConfig config)
        {
            ...
            RipConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.RIP,
        ...
        public void SetEigrpConfiguration(EigrpConfig config)
        {
            ...
            EigrpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.EIGRP,
        ...
        public void SetIgrpConfiguration(IgrpConfig config)
        {
            ...
            IgrpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.IGRP,
        ...
        public void SetVrrpConfiguration(VrrpConfig config)
        {
            ...
            VrrpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.VRRP,
        ...
        public void SetHsrpConfiguration(HsrpConfig config)
        {
            ...
            HsrpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.HSRP,
        ...
        public void SetCdpConfiguration(CdpConfig config)
        {
            ...
            CdpConfig = config;
            ParentNetwork?.EventBus?.PublishAsync(new Events.ProtocolConfigChangedEventArgs(Name, ProtocolType.CDP,
        ...
        /// </summary>
        public virtual InterfaceConfig? GetInterface(string name)
        {
            return Interfaces.ContainsKey(name) ? Interfaces[name] : null;
        }
        ...
        {
            return Vlans.ContainsKey(id) ? Vlans[id] : null;
        }
        ...
        {
            return AccessLists.ContainsKey(number) ? AccessLists[number] : null;
        }
        ...
        {
            return PortChannels.ContainsKey(number) ? PortChannels[number] : null;
        }
        ...
        {
            return SystemSettings.ContainsKey(name) ? SystemSettings[name] : null;
        }
        ...
        protected virtual void UpdateArpTable(string destIp)
        {
            ...
            var destDevice = ParentNetwork.FindDeviceByIp(destIp);
            if (destDevice == null) return;
            // Find dest interface
        ...
        /// </summary>
        public (NetworkDevice device, string interfaceName)? GetConnectedDevice(string localInterfaceName)
        {
            if (ParentNetwork == null)
                return null;
        ...
        /// </summary>
        protected virtual bool IsDestinationIcmpBlocked(NetworkDevice destDevice, string destInterfaceName, string destination)
        {
