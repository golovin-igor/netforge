...
{
    /// <summary>
    /// LEGACY TESTS: EIGRP protocol tests for old implementation in NetForge.Simulation.Common.
    /// These tests are for the legacy EIGRP implementation that will be migrated to the new protocol architecture.
    /// Once EIGRP is migrated to NetForge.Simulation.Protocols.EIGRP, create new tests in NetForge.Simulation.Protocols.Tests.
    /// </summary>
