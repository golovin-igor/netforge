...
{
    /// <summary>
    /// LEGACY TESTS: HSRP protocol tests for old implementation in NetForge.Simulation.Common.
    /// These tests are for the legacy HSRP implementation that will be migrated to the new protocol architecture.
    /// Once HSRP is migrated to NetForge.Simulation.Protocols.HSRP, create new tests in NetForge.Simulation.Protocols.Tests.
    /// </summary>
