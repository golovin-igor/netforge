...
{
    /// <summary>
    /// LEGACY TESTS: VRRP protocol tests for old implementation in NetForge.Simulation.Common.
    /// These tests are for the legacy VRRP implementation that will be migrated to the new protocol architecture.
    /// Once VRRP is migrated to NetForge.Simulation.Protocols.VRRP, create new tests in NetForge.Simulation.Protocols.Tests.
    /// </summary>
