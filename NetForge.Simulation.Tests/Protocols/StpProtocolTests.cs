...
{
    /// <summary>
    /// LEGACY TESTS: STP protocol tests for old implementation in NetForge.Simulation.Common.
    /// These tests are for the legacy STP implementation that will be migrated to the new protocol architecture.
    /// Once STP is migrated to NetForge.Simulation.Protocols.STP, create new tests in NetForge.Simulation.Protocols.Tests.
    /// </summary>
