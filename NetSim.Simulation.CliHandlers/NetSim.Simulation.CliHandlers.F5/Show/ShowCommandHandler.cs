...
namespace NetSim.Simulation.CliHandlers.F5.Show
{
    /// <summary>
    ...
    public class ShowCommandHandler : VendorAgnosticCliHandler
    {
        ...
        protected override CliResult ExecuteCommand(CliContext context)
        {
            ...
            if (context.CommandParts.Length == 1)
            {
                ...
                var output = $@"F5 BIG-IP System Information
=============================
...
Available show commands:
  ...
  show sys";
        ...
        private CliResult ShowVersion(NetworkDevice device)
        {
            var output = @"F5 BIG-IP System
=================
Product: BIG-IP
Version: 16.1.3.2
Build: 0.0.10
...
CPU: 8 cores";
        ...
        private CliResult ShowRunningConfig(NetworkDevice device)
        {
            var output = $@"! F5 BIG-IP Configuration
! Generated by NetSim Simulation
!
hostname {device.GetHostname()}
!
...
!";
        ...
        private CliResult ShowInterfaces(NetworkDevice device)
        {
            var output = @"Interface Status Information
===========================
...
1.4        UP      172.16.0.1      255.255.0.0";
        ...
        private CliResult ShowLtm(NetworkDevice device, string[] args)
        {
            if (args.Length == 0)
            {
                var output = @"LTM (Local Traffic Manager) Objects
===================================
Available objects:
  pool
  virtual
  ...
  profile";
        ...
        private CliResult ShowLtmPool(NetworkDevice device)
        {
...
db_pool      192.168.2.10:3306   tcp      UP
        ...
        private CliResult ShowLtmVirtual(NetworkDevice device)
        {
...
db_virtual      10.0.0.102:3306   db_pool   UP";
        ...
        private CliResult ShowLtmNode(NetworkDevice device)
        {
...
192.168.2.11    UP        UP";
        ...
        private CliResult ShowGtm(NetworkDevice device)
        {
...
Contact F5 Networks for licensing information.";
        ...
        private CliResult ShowAsm(NetworkDevice device)
        {
...
Contact F5 Networks for licensing information.";
        ...
        private CliResult ShowApm(NetworkDevice device)
        {
...
Contact F5 Networks for licensing information.";
        ...
        private CliResult ShowNet(NetworkDevice device)
        {
...
Gateway: 192.168.1.1";
        ...
        private CliResult ShowArp(NetworkDevice device)
        {
        ...
        private CliResult ShowSys(NetworkDevice device)
        {
